        ...
        <section onClick={handleClick}
            ...
            <div className={`absolute top-4 left-6 right-6 z-10 text-white text-sm transition-opacity duration-700 ${
                ...
                <p className="text-sm xl:text-base whitespace-normal break-words">
                    Site vitrine développé et intégré pour OTT Fashion, une marque dynamique et tendance de prêt-à-porter. Projet réalisé en freelance, conçu sous WordPress avec Elementor Pro, mettant en valeur l’univers de la marque à travers un design moderne et attractif, avec une intégration 100% responsive pour une expérience optimale sur tous les appareils.
                </p>
            ...
            <div className="absolute bottom-6 left-6 z-10">
                <h2 className="text-white text-2xl nohemi font-bold">OTT-Fashion<span className="font-extralight">.fr</span></h2>
            </div>
            <div className="absolute bottom-6 right-6 z-10">
                <a href="https://ott-fashion.fr" target="_blank" rel="noopener noreferrer"
            ...
            <img className="h-full object-cover object-top rounded-2xl w-full absolute top-0 left-0 opacity-80 z-0"
                src="images-projet/website-ottfashion.jpg" alt="" />
        </section>
    </>
    );
    }